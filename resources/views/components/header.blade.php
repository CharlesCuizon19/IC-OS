...
<div class="container fixed z-50 w-full mx-auto">
    <header x-data="{ open: false }"
        ...
        <div class="items-center justify-center hidden lg:flex">
            <a href="#"
                class="bg-[#E94B4D] hover:bg-[#c53b3d] text-nowrap text-white font-medium h-fit px-10 py-3 rounded-full text-sm shadow">
                Join IC-OS
            </a>
        </div>
